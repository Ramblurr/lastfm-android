...
public class RadioHandshake
{
    ...
    RadioHandshake( String username, String md5Password )
    {
        m_userName = username;
    ...
    void connect()
    {
        ...
        try
        {
            ...
            for( String param: params )
            {
                ...
                m_parameters.put( curParam[0], ( curParam.length > 1 ) ? curParam[1] : "" );
                Log.i( "Last.fm", "parameter[" + curParam[0] + "] = " + (( curParam.length > 1 ) ? curParam[1] : "" ));
            }
        }
