...
import fm.last.android.scrobbler.Event.EventActivityResult;
...
public class Metadata extends Activity {
	...
	private OnItemClickListener mEventOnItemClickListener = new OnItemClickListener(){
		...
		public void onItemClick(final AdapterView<?> parent, final View v,
            ...
            Intent intent = fm.last.android.scrobbler.Event.intentFromEvent(Metadata.this, event);
			try {
				Event[] events = mServer.getUserEvents(ScrobblerApplication.the().getSession().getName());
				for(Event e : events) {
